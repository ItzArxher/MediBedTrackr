...
# \_______/  \_______| \_______| \_______| \_______|\__|  \__|
    ...
    def bedden():
        ...
        curr.execute("SELECT b.id, a.naam, b.is_beschikbaar, a.id FROM bed as b INNER JOIN afdeling AS a ON b.afdeling_id = a.id")
        B_afdeling = curr.fetchall()
        curr.execute("SELECT b.id, a.naam, b.is_beschikbaar FROM bed as b INNER JOIN afdeling AS a ON b.afdeling_id = a.id")
